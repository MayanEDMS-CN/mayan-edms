...
from documents.models import DocumentPage, DocumentType, DocumentVersion, Document
...
class DocumentServiceTicketRelatedSettings(models.Model):
    ...
    def __str__(self):
        return "[%s - %s]: %s" % (self.document, self.ticket, _("Related") if self.related else _("Not Related"))
